...
# OVERRIDE #
func _handle_previous_ghost_deaths_setup():
...
func on_ghost_hit_from_server(hit_ghost_player_owner, hit_ghost_id) -> void:
	var ghost 
...
func on_quiet_ghost_hit_from_server(hit_ghost_player_owner, hit_ghost_id) -> void:
