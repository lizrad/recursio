...
var white_balance_warm_color = preload("res://addons/PostProcessingTool/assets/warm_color.res")
var white_balance_cool_color = preload("res://addons/PostProcessingTool/assets/cool_color.res")
